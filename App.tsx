...
const TRANSLATIONS = {
  en: {
    ...
    seedHelp: "Same seed + prompt reproduces the same image. Leave blank for random.", tempHelp: "Lower = precise & consistent. Higher = creative & varied.", tempPrecise: "Precise", tempBalanced: "Balanced", tempBold: "Bold", activeProvider: "Provider", rateLimitHint: "Rate limit reached — please retry shortly.",
  ...
  zh: {
    ...
    seedHelp: "相同種子 + 提示詞會重現同一張圖。留空則隨機。", tempHelp: "數值越低越精準穩定,越高越有創意多變。", tempPrecise: "精準", tempBalanced: "平衡", tempBold: "大膽", activeProvider: "供應商", rateLimitHint: "已達速率限制 — 請稍候重試。",
