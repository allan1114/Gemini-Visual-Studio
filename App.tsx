...
const TRANSLATIONS = {
  en: {
    ...
    engineFlashDesc: "Fast · versatile · needs billing", engineProDesc: "Top quality · 4K · needs billing", engineImagenDesc: "Free tier · balanced", engineImagenFastDesc: "Free tier · fastest", engineImagenUltraDesc: "Free tier · finest detail",
    seedHelp: "Same seed + prompt reproduces the same image. Leave blank for random.", tempHelp: "Lower = precise & consistent. Higher = creative & varied.", tempPrecise: "Precise", tempBalanced: "Balanced", tempBold: "Bold", activeProvider: "Provider", rateLimitHint: "Rate limit reached — please retry shortly.", engineManagedNote: "Active provider's model — change it in the Key Wallet.", editUnsupportedNote: "The active provider only supports image generation. Switch to a Gemini key in the Key Wallet to use editing.",
  ...
  zh: {
    ...
    engineFlashDesc: "快速 · 全能 · 需計費", engineProDesc: "最高畫質 · 4K · 需計費", engineImagenDesc: "免費額 · 均衡", engineImagenFastDesc: "免費額 · 最快", engineImagenUltraDesc: "免費額 · 最精細",
    seedHelp: "相同種子 + 提示詞會重現同一張圖。留空則隨機。", tempHelp: "數值越低越精準穩定,越高越有創意多變。", tempPrecise: "精準", tempBalanced: "平衡", tempBold: "大膽", activeProvider: "供應商", rateLimitHint: "已達速率限制 — 請稍候重試。", engineManagedNote: "目前供應商的模型 — 可於金鑰錢包更改。", editUnsupportedNote: "目前供應商只支援生成圖像。如需編輯功能,請於金鑰錢包切換至 Gemini key。",
