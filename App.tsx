...
const GalleryGrid = lazy(() =>
  import('./components/StudioViews').then((m) => ({ default: m.GalleryGrid }))
);
const PresetsList = lazy(() =>
  import('./components/StudioViews').then((m) => ({ default: m.PresetsList }))
);
const MembersDB = lazy(() =>
  import('./components/StudioViews').then((m) => ({ default: m.MembersDB }))
);
...
const TRANSLATIONS = {
  en: {
    ...
    construction: 'Visual Workspace',
    promptLabel: 'Custom Subject',
    selectedPromptLabel: 'Visual Prompt Sequence',
    subjectPlaceholder: 'Type a core subject...',
    negativeLabel: 'Negative Elements',
    negativePlaceholder: 'e.g., blurry...',
    manifest: 'Synthesize Vision',
    synthesizing: 'Synthesizing...',
    store: 'Save to Studio',
    saveAll: 'Save All Results',
    storing: 'Saving...',
    saved: 'Saved!',
    tuning: 'Advanced Engine Tuning',
    ...
    emptyStudio: 'Studio empty.',
    searchPlaceholder: 'Search...',
    transformPhoto: 'Transform Photo',
    createFromScratch: 'Create from Description',
    bulkDownload: 'Download ZIP',
    promptRequired: 'Prompt is required.',
    importSuccess: 'Import success.',
    importError: 'Import error.',
    help: 'Help',
    pickOne: 'Select result:',
    generatingMany: 'Creating {current}/5...',
    engineFlash: 'Gemini 3.0 Flash',
    enginePro: 'Gemini 3.0 Pro',
    engineImagen: 'Imagen 4 (Free)',
    engineImagenFast: 'Imagen 4 Fast (Free)',
    engineImagenUltra: 'Imagen 4 Ultra (Free)',
    quotaError: 'API limit reached.',
    dropHint: 'Drag tags here',
    importData: 'Import Data',
    engineFlashDesc: 'Fast · versatile · needs billing',
    engineProDesc: 'Top quality · 4K · needs billing',
    engineImagenDesc: 'Free tier · balanced',
    engineImagenFastDesc: 'Free tier · fastest',
    engineImagenUltraDesc: 'Free tier · finest detail',
    seedHelp: 'Same seed + prompt reproduces the same image. Leave blank for random.',
    tempHelp: 'Lower = precise & consistent. Higher = creative & varied.',
    tempPrecise: 'Precise',
    tempBalanced: 'Balanced',
    tempBold: 'Bold',
    activeProvider: 'Provider',
    rateLimitHint: 'Rate limit reached — please retry shortly.',
    ...
    helpTitle: 'Studio Master Guide',
    helpClose: 'Return to Studio',
    helpIntro: 'Welcome to Gemini Visual Studio. Master high-end AI synthesis with these steps:',
    helpStep1:
      '1. Visual Construction: Drag and drop professional tags from our curated library into the workspace. Combine them with core subjects to shape your artistic vision with precision.',
    helpStep2:
      "2. Engine Tuning: Toggle between Gemini 3 Pro for ultra-realistic 4K results or Flash for rapid iterations. Use 'Deterministic Seeds' to replicate specific aesthetics or increase 'Creativity' for bold variations.",
    helpStep3:
      "3. Advanced Modes: Use 'AI Edit' for surgical modifications of existing photos, or 'AI Avatar' to generate consistent character variations while preserving key facial features.",
    helpStep4:
      "4. Personal Studio: Manage your library in 'My Studio'. All creations are stored in your secure browser-based vault, accessible offline and ready for high-resolution export.",
    uploadPrompt: 'Upload Prompt',
    aiInfo: 'AI Runtime Info',
    currentModel: 'Current Model',
    genCount: 'Gen Count',
    thisGenCons: 'Session Consumption',
    inputAmount: 'Input',
    outputAmount: 'Output',
    ...
    expandPrompt: 'Expand with AI',
    expanding: 'Refining...',
    copyPrompt: 'Copy Prompt',
    copied: 'Copied!',
    editModeWhole: 'Whole Image',
    editModeArea: 'Area In-paint',
    brushSize: 'Brush Size',
    brushSoftness: 'Softness',
    clearMask: 'Clear Mask',
    applyInpaint: 'Apply Area Edit',
    compareLabel: 'Hold to Compare',
    removeBg: 'Remove BG',
    aiSuggest: 'AI Suggest',
    stylePresets: 'Style Presets',
    editModeAdvanced: 'Advanced Tools',
    healingBrush: 'Healing Brush',
    healingPrompt:
      'Seamlessly remove the object in the masked area and fill with a realistic background that matches the surrounding texture and lighting.',
    ...
    welcomeSubtitle:
      'Professional-grade AI image synthesis platform. Sign in to start your creative journey.',
    guestMode: 'Continue as Guest',
    guestWarning: 'Cloud sync disabled in guest mode.',
    fetchError:
      'Network error: Failed to fetch resource. Please check your connection or CORS settings.',
  },
  zh: {
    gallery: '探索畫廊',
    create: '創作中心',
    ...
    construction: '視覺工作區',
    promptLabel: '核心主體',
    selectedPromptLabel: '視覺提示序列',
    subjectPlaceholder: '輸入創作主體...',
    negativeLabel: '排除元素',
    negativePlaceholder: '例如：模糊...',
    manifest: '啟動創作',
    synthesizing: '正在合成...',
    store: '存入工作室',
    saveAll: '儲存全部結果',
    ...
    help: '手冊',
    pickOne: '選擇作品：',
    generatingMany: '合成中 {current}/5...',
    engineFlash: 'Gemini 3.0 Flash',
    enginePro: 'Gemini 3.0 Pro',
    engineImagen: 'Imagen 4（免費）',
    engineImagenFast: 'Imagen 4 Fast（免費）',
    engineImagenUltra: 'Imagen 4 Ultra（免費）',
    quotaError: '配額已滿。',
    dropHint: '將元素拖曳至此處組合視覺序列',
    importData: '導入數據',
    engineFlashDesc: '快速 · 全能 · 需計費',
    engineProDesc: '最高畫質 · 4K · 需計費',
    engineImagenDesc: '免費額 · 均衡',
    engineImagenFastDesc: '免費額 · 最快',
    engineImagenUltraDesc: '免費額 · 最精細',
    seedHelp: '相同種子 + 提示詞會重現同一張圖。留空則隨機。',
    tempHelp: '數值越低越精準穩定,越高越有創意多變。',
    tempPrecise: '精準',
    tempBalanced: '平衡',
    tempBold: '大膽',
    activeProvider: '供應商',
    ...
    bulkDelete: '刪除選中項',
    zipping: '正在打包...',
    selectedCount: '已選中 {count} 個項目',
    memberDb: '成員數據庫',
    helpTitle: '進階使用手冊',
    helpClose: '返回工作室',
    helpIntro: '歡迎使用 Gemini Visual Studio。透過以下步驟掌握專業級 AI 合成：',
    helpStep1:
      '1. 構建視覺：從專業標籤庫中拖拽元素至工作區。將標籤與核心提示詞結合，精確控制光影、構圖與藝術風格。',
    helpStep2:
      '2. 引擎調試：切換 Gemini 3 Pro 獲得 4K 極致寫實畫質，或使用 Flash 進行快速草稿。調整『隨機種子』以重現特定效果，或提高『創造力』以探索意想不到的藝術變化。',
    helpStep3:
      '3. 進階模式：使用『AI 編輯』對現有照片進行外科手術般的進階局部修改；或利用『AI 頭像』功能，在保持人物面部特徵一致的同時，生成不同風格的視覺版本。',
    helpStep4:
      '4. 個人工作室：在『個人工作室』管理所有作品。您的創作將儲存在瀏覽器的安全本地庫中，支持離線訪問與高清導出。',
    uploadPrompt: '上傳提示詞',
    aiInfo: '當前運行資訊',
    currentModel: '當前模型',
    genCount: '生成次數',
    ...
    aiSuggest: 'AI 建議',
    stylePresets: '風格預設',
    editModeAdvanced: '進階工具',
    healingBrush: '修復畫筆',
    healingPrompt: '無縫移除遮罩區域中的物體，並填充與周圍紋理和光影匹配的真實背景。',
...
const App: React.FC = () => {
    ...
    const checkInitialSession = async () => {
      ...
      try {
        ...
        if (getErrMsg(err).includes('Failed to fetch')) {
          setAuthError(
            language === 'zh'
              ? '無法連線至 Supabase，請檢查 VITE_SUPABASE_URL 是否正確。'
              : 'Cannot connect to Supabase. Please check VITE_SUPABASE_URL.'
          );
        }
        setIsInitialLoading(false);
      } finally {
  ...
  const handleBulkDelete = async () => {
    ...
    const confirm = window.confirm(
      language === 'zh'
        ? `確定要刪除選中的 ${selectedIds.size} 個項目嗎？`
  ...
  const handleExportData = () => {
    ...
    link.href = url;
    link.download = `gemini-studio-export-${Date.now()}.json`;
    link.click();
  ...
  const filtered = useMemo(() => {
    let res =
      view === View.STUDIO || view === View.PROMPTS
        ? allEntries.filter((e) => e.userId === user?.id)
        : allEntries;
    if (searchTerm) {
        ...
        <div className="relative glass w-full max-w-md p-10 rounded-[3rem] border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] z-10">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-white/[0.03] border border-white/10 rounded-2xl pl-14 pr-6 py-4 outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all text-sm font-medium"
              />
            </div>
            <div className="relative group">
            ...
            <button
              ...
              className="w-full py-5 bg-indigo-600 hover:bg-indigo-500 rounded-2xl font-black text-xs uppercase shadow-xl transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center"
            >
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-bold text-gray-500">
              <span className="bg-[#0c0c0c] px-4">Social Access</span>
            </div>
          </div>
          <button
            onClick={handleGoogleLogin}
            className="w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-3 mb-8"
          >
    ...
    <div className="flex h-screen overflow-hidden bg-[#050505] text-gray-100 relative">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header className="px-8 py-5 border-b border-white/5 flex justify-between items-center bg-[#0a0a0a]/50 backdrop-blur-xl z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-500/10 text-indigo-400 rounded-full text-xs font-bold"
            >
            ...
            <button
              onClick={() => setShowSettings(true)}
              title={language === 'zh' ? 'API Keys 設定' : 'API Key Settings'}
              className="px-3 py-2 bg-white/5 rounded-full text-xs font-bold hover:bg-white/10 transition-colors"
            >
              <i className="fa-solid fa-gear"></i>
            </button>
            <button
              onClick={() => setLanguage(language === 'en' ? 'zh' : 'en')}
              className="px-4 py-2 bg-white/5 rounded-full text-xs font-bold"
            >
              {language === 'en' ? 'EN' : '中文'}
            </button>
        ...
        <div
          ...
          className="flex-1 overflow-y-auto p-8 scrollbar-hide relative"
        >
          <ErrorBoundary>
            <Suspense fallback={<ViewLoader />}>
              {view === View.GENERATE && (
                <GenerateView
                  ...
                  onSavePreset={(p) => {
                    StorageService.savePreset(p, user.id).then(() => refreshData(user));
                  }}
                  user={user}
                  onAuthRequired={() => {}}
                  initialData={remixData}
                  onClearInitialData={() => setRemixData(null)}
                />
              )}
              {view === View.EDIT && (
                <EditView
                  ...
                  usageStats={usageStats}
                  onStatsUpdate={handleStatsUpdate}
                  onSave={async (items, p, tags, m, config) => {
                    const currentUserId = user?.id || 'anon';
              ...
              {(view === View.GALLERY || view === View.STUDIO || view === View.PROMPTS) && (
                <GalleryGrid
                  ...
                  selectAll={() => setSelectedIds(new Set(filtered.map((e) => e.id)))}
                  ...
                  isZipping={isZipping}
                  t={t}
                  isPromptView={view === View.PROMPTS}
                  onRemix={handleRemix}
                />
              )}
              {view === View.PRESETS && (
                <PresetsList
                  presets={presets}
                  onDelete={(id) => {
                    StorageService.deleteEntry(id, user?.id).then(() => refreshData(user));
                  }}
                  t={t}
                />
              )}
              {view === View.DATABASE && user && (
                <MembersDB members={members} isLoading={isDbLoading} t={t} />
              )}
            </Suspense>
          </ErrorBoundary>
        </div>
          ...
          >
            ...
            <div className="space-y-4">
              {[t.helpStep1, t.helpStep2, t.helpStep3, t.helpStep4].map((step, i) => (
                <div
                  key={i}
                  className="p-4 bg-white/[0.03] border border-white/10 rounded-2xl text-sm text-gray-300 leading-relaxed"
                >
                  {step}
                </div>
              ))}
